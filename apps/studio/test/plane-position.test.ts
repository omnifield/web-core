// Арифметика двумерной плоскости матрицы (`shared/ui/plane/lib/position.ts`).
//
// Матрицу до этого собирали вложенными каруселями и не собрали ни разу. Разбор 2026-09-18
// (след в `features/demo-stand/README.md`) показал две причины, и обе проверяются здесь:
//
