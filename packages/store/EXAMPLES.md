...
отдающий `undefined` (параметр маршрута ещё не появился), — валидный ключ `Map`, и стор под него
заведётся настоящий; если этого не нужно, не зови семью, пока ключа нет.
