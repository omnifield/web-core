...
export const AXES: readonly Axis[] = [
  ...
  },
  {
    ...
    ceiling: unbounded(
      "сверху семя не ограничено. Ограничена сама КОЛОНКА, и не нашим потолком: 1.4.8 Visual Presentation (AAA) держит строку не длиннее 80 знаков — это про ступени, а не про семя. Ряд идёт до 72 знаков, то есть остаётся ниже потолка и целиком внутри канона измерения (45–75 знаков, идеал 66 — Bringhurst), а сам идеал лежит между ступенями 64 и 72",
    ),
    continuous: true,
  },
  {
