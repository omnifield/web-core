...
| Модель API | `parseSchema`, `asSchemaDocument`, `endpointOf`, `groupEndpoints`, `schemaNodeToZod` | наш формат документа и работа с ним |
...
🧪 Vitest + jsdom. **136 тестов, все зелёные:**
