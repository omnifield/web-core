...
- **styles** — реактивный доступ к вычисленным CSS-значениям. [docs](https://primitives.solidjs.community/package/styles/) · [src](https://github.com/solidjs-community/solid-primitives/tree/main/web-core/styles)
...
- **clipboard** — операции копирования/вставки. [docs](https://primitives.solidjs.community/package/clipboard/) · [src](https://github.com/solidjs-community/solid-primitives/tree/main/web-core/clipboard)
