...
export const recipe: SlotRecipe = {
  base: {
    ...
    content: {
      ...
      // `content`-подобных частей вообще, см. web-core/ui/README.md про части-контейнеры).
    ...
    indicator: {
      ...
      // берёт, поэтому предок назван явно (см. web-core/ui/README.md про переменные не своих частей).
      ancestors: [
        {
          component: "toc",
          part: "root",
