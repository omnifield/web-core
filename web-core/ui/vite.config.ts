...
//
// Шесть входов, ДВЕ ветки. `solid: true` — там, где на выходе настоящие Solid-компоненты и нужны
...
// JSX/Solid/`@kobalte/core`. `./docs` — тоже данные, и вдобавок единственный вход, который уезжает
// не одним файлом: текст каждого компонента лежит за динамическим импортом, и сборка режет его
// отдельными кусками (`FAQ.md` зоны).
