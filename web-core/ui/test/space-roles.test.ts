...
//
// НАЙДЕНО РЕВИЗИЕЙ (2026-08-30, `web-core/style/src/dimension.ts`, `SPACE_ROLES`): почти весь
...
/** Ступень высоты → набивка и шрифт, которые едут ВМЕСТЕ с ней (`web-core/style` `SPACE_ROLES`,
...
// дев-сервера (`web-core/build/src/workspace-source.ts`) резолвил такой импорт иначе, чем
